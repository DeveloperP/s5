...
@section('content')
    <div  class="container-fluid" id="content-new">
        <h3><span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;PORT LIST : EDIT</h3>
        <div class="well">
            ...
            @endif
                {!! Form::model($port, ['method' => 'PATCH', 'route' => ['ports.update', $port->id],'class'=>'form-horizontal','role'=>'form']) !!}
                {{ csrf_field() }}
            <div class="panel- panel-primary" id="button-bar">
                ...
                <a href="{{ route('ports.index') }}" id="btn-link">
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('port_name',null,['class' => 'input-field input-sm text-upper border-2px','v-model'=>'newPort.port_name','style'=>'text-transform:uppercase']) !!}
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered port" cellspacing="0" width="100%">
                            <thead>
                            <tr>
