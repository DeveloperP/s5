...
@section('content')
    <div  class="container-fluid" id="content-new">
        <h3><span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;BRANCH LIST</h3>
        <div class="well">
            ...
            {!! Form::model(new App\Models\PslBranch, ['route' => ['branches.store'],'class'=>'form-horizontal','role'=>'form']) !!}
            {{ csrf_field() }}
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('branch_name',null,['class' => 'input-field input-sm text-upper border-2px','v-model'=>'newBranch.branch_name']) !!}
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover branches" cellspacing="0" width="100%">
                            <thead>
                            <tr>
