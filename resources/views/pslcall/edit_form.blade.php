        ...
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="col-md-9">
                        {{Form::select('purposes[]',array_map('strtoupper', $purposes),$taglist,['class'=>'col-md-9', 'multiple','style'=>'height: 290px'])}}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('ata_actual_time',null,['class' => 'input-field input-sm ','id'=>"atadatetime"]) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('atb_actual_time',null,['class' => 'input-field input-sm ','id'=>"atbdatetime"]) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('atc_actual_time',null,['class' => 'input-field input-sm ','id'=>"atcdatetime"]) !!}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                {!! Form::text('atd_actual_time',null,['class' => 'input-field input-sm ','id'=>"atddatetime"]) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="checkbox">
                                    <label>
                                        {{ Form::checkbox('cancel_call', $call->cancel_call,null,['v-model'=>'showcall']) }}<b>Cancel Call</b>
        ...
        <div class="row">
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="input-field input-sm" id="name" placeholder="name" data-error="Data type is invalid" >
                    </div>-->
                    <div class="col-md-12 col-sm-12">
                        <div class="checkbox">
                            <label>
                                {{ Form::checkbox('no_cost_time', '1',null,['v-model'=>'show_cost']) }}<b>No Cost Time Saving Archived</b>
                                <!--<input type="checkbox" v-model="show_cost" name="no_cost_time" ><b>No Cost Time Saving Archived</b>-->
                            </label>
                        </div>
                        <div class="help-block with-errors"></div>
                    </div>
...
<div class="row hidden-sm">
    <div class="panel panel-primary" >
        <div class="panel-body">
            ...
            <div class="col-md-2">
                {!! Form::label('prospect', 'Prospect',['class'=>'control-label ']) !!}
            </div>

            <div class="col-md-9 col-sm-12" >
                {!! Form::textarea('prospect',null,['class' => 'input-field input-sm','rows'=>'3']) !!}
                <div class="help-block with-errors"></div>
            </div>

            <div class="col-md-1">
                <button><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></button>
                <button><span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span></button>
            </div>
