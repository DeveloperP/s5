...
@section('content')
    <div  class="container-fluid" id="content-new">
        <h3><span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;PRINCIPAL LIST</h3>
        <div class="well">
            ...
            {!! Form::model(new App\Models\PslPrincipal, ['route' => ['principals.store'],'class'=>'form-horizontal','role'=>'form']) !!}
            {{ csrf_field() }}
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <div class="col-sm-4  text-right hidden-xs">
                        {!! Form::label('principal_name','Principal Name :',null,['class' => 'control-label']) !!}
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('principal_name',null,['class' => 'input-field input-sm text-upper border-2px','v-model'=>'newPrincipal.principal_name']) !!}
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover principal" cellspacing="0" width="100%">
                            <thead>
                            <tr>
