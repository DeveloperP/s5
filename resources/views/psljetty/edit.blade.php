...
@section('content')
    <div  class="container-fluid" id="content-new">
        <h3><span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;JETTY LIST : EDIT</h3>
        <div class="well">
            ...
            @endif
            {!! Form::model($jetty, ['method' => 'PATCH', 'route' => ['jetties.update', $jetty->id],'class'=>'form-horizontal','role'=>'form']) !!}
            {{ csrf_field() }}
            ...
            <div class="panel- panel-primary" id="button-bar">
                ...
                <a href="{{ route('jetties.index') }}" id="btn-link">
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('jetty_name',null,['class' => 'input-field input-sm text-upper border-2px','v-model'=>'newJetty.jetty_name','style'=>'text-transform:uppercase']) !!}
            ...
            <div class="panel panel-primary">
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered jetty" cellspacing="0" width="100%">
                            <thead>
                            <tr>
